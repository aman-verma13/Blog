...
export default function ArticleCard() {
    return (
        <div>
            ...
            <p className='py-2 text-sm text-slate-500 uppercase'>Facts</p>
            <h1 className='text-xl font-semibold'>
                <a className='cursor-pointer'>The Travel Insurance Catch that can Double Your Cover in Two Months</a>
            </h1>
